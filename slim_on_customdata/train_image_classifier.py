...
def main(_):
  ...
  print("Let's start training a mother fucking NN")
  tf.logging.set_verbosity(tf.logging.INFO)
  with tf.Graph().as_default():
    ######################
    # Config model_deploy#
    ######################
    print("Config the deployment")
    ...
    #####################################
    print("Set up image preprocessing")
    ...
    #################################
    print("Configure average, possibly, if necessary")
    ...
    #########################################
    print("Configure optimization procedure")
